...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // Make absolutely sure these props are set before play()
    v.muted = true;
    v.defaultMuted = true;
    // @ts-expect-error - playsInline is a known HTMLVideoElement prop on iOS
    v.playsInline = true;
    ...
    const tryPlay = async () => {
      try {
        ...
        // Wait until we can play, then try again
    ...
    // As a final fallback, start on first user gesture (iOS LPM etc.)
    const onUserGesture = () => {
